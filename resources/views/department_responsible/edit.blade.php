...
@section('title', 'Editar Responsável Departamento')
...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <form action="{{route('departmentsResponsibles.update', $departmentResponsible->id)}}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="js-basic form-control" name="people_id">
                            ...
                            @foreach($responsibles as $responsible)
                                <option value="{{ $departmentResponsible->id }}">{{ $responsible->name }}</option>
                            @endforeach
                        </select>
                        @error('people_id')
                            <div class="text-danger">{{ $message }}</div>
